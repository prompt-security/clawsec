...
- 2026-07-22: Added `wiki/multi-harness-suite-design.md` as the proposed architecture, lifecycle, distribution, and migration contract for harness cores, suites, and optional guardians.
